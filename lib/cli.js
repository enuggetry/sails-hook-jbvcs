...
function runModule(itGottaWatch, interval) {
	...
	jbvcs.isApiLive()
		...
		.then(function(foundIt) {
			...
			return jbvcs.cloneTags(info.tags, info.config);
		})
		.then(function(done) {
			//Cloning done!
